...
public final class ImageLoader {
    ...
    public static void loadFit(Context context, String url, ImageView view, int defaultResId) {
        if ( NetUtil.isWifiConnected(context)) {
            ...
            Glide.with(context).load(url).apply(new RequestOptions().fitCenter().placeholder(defaultResId).dontAnimate()).into(view);
        } else {
    ...
    public static void loadFitCenter(Context context, String url, ImageView view, RequestListener listener) {
        Glide.with(context).load(url).apply(new RequestOptions().fitCenter().dontAnimate())
    ...
    public static void loadCenterCrop(Context context, String url, ImageView view, RequestListener listener) {
        Glide.with(context).load(url).apply(new RequestOptions().centerCrop().dontAnimate())
               .listener(listener).into(view);
    }
    ...
    public static void loadFitOverride(Context context, String url, ImageView view, int defaultResId,
        ...
        if ( NetUtil.isWifiConnected(context)) {
            Glide.with(context).load(url).apply(new RequestOptions().fitCenter().placeholder(defaultResId).dontAnimate().override(width, height))
                    .into(view);
        } else {
            view.setImageResource(defaultResId);
        }
