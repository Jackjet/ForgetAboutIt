...
public final class AnimateHelper {
     ...
     * @param duration  时间
     */
    public static Animator doHeartBeat(View view, int duration) {
    ...
    public static Animator doHappyJump(View view, int jumpHeight, int duration) {
        ...
        Keyframe translationY1 = Keyframe.ofFloat(0f, -jumpHeight/2);
        ...
        Keyframe translationY6 = Keyframe.ofFloat(0.5f, -jumpHeight/2);
     ...
     * @param duration
     */
    public static ValueAnimator  doClipViewHeight(final View view, int srcHeight, int endHeight, int duration) {
